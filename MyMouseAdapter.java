...
//                    	System.out.println("Number of mines neighbors: " + 	myPanel.minesSurroundingOurSquare[myPanel.mouseDownGridX][myPanel.mouseDownGridY] );
//                        myPanel.minesUncovered[myPanel.mouseDownGridX][myPanel.mouseDownGridY] = true;
//                        
//                        if(myPanel.minesUncovered[0][0]){
//                        	myPanel.resetGame();
			...
			if ((myPanel.mouseDownGridX == -1) || (myPanel.mouseDownGridY == -1)) {
				...
				if ((gridX == -1) || (gridY == -1)) {
					...
					if ((myPanel.mouseDownGridX != gridX) || (myPanel.mouseDownGridY != gridY)) {
						...
						Color newColor = null;
						if(myPanel.minesUncovered[myPanel.mouseDownGridX][myPanel.mouseDownGridY] == true){
							for (int i=0; i<9; i++){
								for(int j=0; j<9; j++){
									if(myPanel.minesUncovered[i][j]==true){
